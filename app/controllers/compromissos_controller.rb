class CompromissosController < ApplicationController
  ...
  def index
    ...
    #setar a data atual no calendário
  ...
  def create
    ...
    respond_to do |format|
      if @compromisso.save
        format.html { redirect_to @compromisso, notice: 'Compromisso registrado com sucesso!' }
  ...
  def destroy
    @compromisso.destroy
    respond_to do |format|
      format.html { redirect_to compromissos_url, notice: 'Compromisso excluído com sucesso!' }
